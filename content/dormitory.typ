...
#let 主体表格 = table(
  ...
  [#quest\ 早于 2003],
  [
    曾经是家属区的一部分，非典时期被征用为非典塔，后空置直到北邮扩招被征用为宿舍；高层曾用作留学生宿舍
...
虽然表里有些距离评价是远，但是巴掌大的北邮再远能有多远呢？不提供到食堂的距离评价：从任何宿舍到食堂都比教学楼群到食堂更近。不提供沙河宿舍到教学楼、科研楼的距离评价。
...
#text(fill: red.darken(25%))[*新生请谨慎参考本表：沙河雁南传言有改造为六人间非上床下桌的计划。*]
